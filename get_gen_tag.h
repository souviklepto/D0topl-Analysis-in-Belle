...
namespace Belle{
  ...
  public:
    ...
    //return the fourVector Position of a or its daughter
    HepLorentzVector Vec4DAU(Gen_hepevt a, int id);
    HepLorentzVector Vec4DAU(Gen_hepevt a, int id, int rank);
    HepLorentzVector AbsVec4DAU(Gen_hepevt a, int id);
    HepLorentzVector AbsVec4DAU(Gen_hepevt a, int id, int rank);
    HepLorentzVector Vec4(Gen_hepevt a);
 
   
    //return the fourmomentum of a or its daughter
    ...
    int Bmode(Gen_hepevt a);
    int Braremode(Gen_hepevt a);
    int Dmode(Gen_hepevt a);
    int MyownB(Gen_hepevt a);

    // return the mother of particle
    ...
    int KsPimaa (Particle & da, int nkid, int gen);
     
    int MiDNum(Particle & pa, int gen);
